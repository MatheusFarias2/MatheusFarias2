...
Sou estudante de **Engenharia de Software** e estou construindo minha trajetória como desenvolvedor, com foco em **backend**, **sistemas desktop**, **automação**, **banco de dados** e **desenvolvimento de jogos**.
...
<table>
  <tr>
    <td width="50%">
      <h3>🎓 Virtum Academy</h3>
      <p>
        Sistema desktop para organização acadêmica, com controle de cursos, disciplinas,
        tutores, laboratórios, aulas e alocações.
      </p>
      <p>
        <strong>Stack:</strong> Python, PySide6, SQLite, openpyxl
      </p>
    </td>
    <td width="50%">
      <h3>🧪 Sistema de Inventário</h3>
      <p>
        Sistema para controle interno de itens permanentes e de consumo em laboratórios,
        com conferência, pendências e relatórios.
      </p>
      <p>
        <strong>Stack:</strong> Python, PySide6, SQLite, Flutter
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🤖 VIRTUM AI</h3>
      <p>
        Assistente desktop experimental para automação segura de tarefas no computador,
        com foco em produtividade, permissões e controle do usuário.
      </p>
      <p>
        <strong>Stack:</strong> Python, automação desktop, interface gráfica
      </p>
    </td>
    <td width="50%">
      <h3>🎮 Projetos em Godot</h3>
      <p>
        Protótipos de jogos com movimentação, física, inimigos, combate, HUD,
        barras de vida, recarga de ataque e mecânicas interativas.
      </p>
      <p>
        <strong>Stack:</strong> Godot, GDScript, lógica de jogos
      </p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="33%">
      <h3>🖥️ Sistemas</h3>
      <p>
        Desenvolvimento de aplicações desktop, organização de dados,
        interfaces gráficas e sistemas voltados para uso real.
      </p>
    </td>
    <td width="33%">
      <h3>⚙️ Backend</h3>
      <p>
        Estudos e projetos envolvendo lógica de negócio, banco de dados,
        estruturação de código e organização de aplicações.
      </p>
    </td>
    <td width="33%">
      <h3>🎮 Game Dev</h3>
      <p>
        Criação de protótipos em Godot, com foco em mecânicas,
        movimentação, combate, inimigos e experiência do jogador.
      </p>
    </td>
  </tr>
</table>
...
Busco desenvolver uma base sólida em backend, banco de dados, versionamento, arquitetura de sistemas e boas práticas, sem deixar de explorar minha criatividade com desenvolvimento de jogos.
